	...
	EYE.extend({
		...
		spacegallery: {
			...
			defaults: {
				...
				after: function(){
	          var doc = (this.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode);
		  index--;
		  if (index<1) index=11;
		  var Image = "img" + index;
		  var Com = doc.getElementById(Image).alt;
		  doc.getElementById("Comment").innerHTML = Com;
						return false}
			},
